    ...
    drawText: function(featureId, style, location) {
        ...
        for (var i = 0; i < numRows; i++) {
            ...
            if (i == 0) {
                ...
                var vpos = vfactor * (numRows - 1);
                if (OpenLayers.BROWSER_NAME === "msie") {
                    var voffset = OpenLayers.Renderer.SVG.LABEL_IE_VOFFSET[align[1]];
                    if (voffset == null) {
                        voffset = .35;
                    }
                    vpos += voffset;
                }
                tspan.setAttribute("dy", vpos + "em");
            } else {
...
/**
 * Constant: OpenLayers.Renderer.SVG.LABEL_IE_VOFFSET
 * {Object}
 */
OpenLayers.Renderer.SVG.LABEL_IE_VOFFSET = {
    "t": .7,
    "b": 0
};
